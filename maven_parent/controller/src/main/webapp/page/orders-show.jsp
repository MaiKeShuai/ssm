                ...
                <div class="row data-type">
                    ...
                    <div class="col-md-4 data">
                        <div class="input-group date">
                            ...
                            <input type="text" class="form-control pull-right"
                                   id="datepicker-a6" value="${orders.product.departureTimeStr}" readonly="readonly">
                        </div>
                    </div>
            ...
            <div class="panel panel-default">
                ...
                <table id="dataList"
                    ...
                    <c:forEach var="traveller" items="${orders.travellers}">
                        ...
                        <tr >
                            <td>
                                <input class="form-control pull-right" type="text" size="10" value="${traveller.travellerTypeStr}"
                                       readonly="readonly">
                            </td>
                            <td><input class="form-control pull-right" type="text" size="10" value="${traveller.name }"
                                       readonly="readonly"></td>
                            <td><input class="form-control pull-right" type="text" size="10" value="${traveller.sex }"
                                       readonly="readonly"></td>
                            <td><input class="form-control pull-right" type="text" size="20"
                                       value="${traveller.phoneNum }" readonly="readonly"></td>
                            <td><input class="form-control pull-right" type="text" size="15"
                                       value="${traveller.credentialsTypeStr}" readonly="readonly"></td>
                            <td><input class="form-control pull-right" type="text" size="28"
