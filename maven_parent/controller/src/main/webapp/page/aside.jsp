...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li id="admin-index">
                <a href="${pageContext.request.contextPath}/page/main.jsp">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li id="system-setting">
                        <a href="${pageContext.request.contextPath}/product/findAllPage.do?page=1&size=3">
                            <i class="fa fa-circle-o"></i> 产品管理
                        </a>
                    </li>
                    <li id="system-setting">
                        <a href="${pageContext.request.contextPath}/orders/findAll.do?page=1&size=3">
